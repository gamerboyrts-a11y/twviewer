...
Chat-tab message composition and sending on bottom screen: touchable input box, draft persistence/display, keyboard pre-fill, SEND semantics, button mapping, logged-out behavior, input-bar status handling.
